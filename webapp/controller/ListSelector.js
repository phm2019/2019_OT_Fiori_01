sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("de.integrata.training.opentext.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias de.integrata.training.opentext.controller.ListSelector
			 */
			 ...
			 * @return {de.integrata.training.opentext.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
