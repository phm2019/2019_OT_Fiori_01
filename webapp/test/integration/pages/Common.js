sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("de/integrata/training/opentext/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("de.integrata.training.opentext.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["de/integrata/training/opentext/localService/mockserver"], function (mockserver) {
